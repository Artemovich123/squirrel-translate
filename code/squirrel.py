...
WINHEIGHT = 540 # height in pixels
...
CAMERASLACK = 90 # насколько далеко от центра перемещается белка перед перемещением камеры
MOVERATE = 11 # как быстро двигается игрок
BOUNCERATE = 6 # как быстро игрок отскакивает (большой медленнее)
BOUNCEHEIGHT = 35 # как высоко игрок подпрыгивает
STARTSIZE = 30 # насколько велик стартовый игрок
WINSIZE = 300 # насколько большим должен быть игрок, чтобы выиграть
INVULNTIME = 3 # сколько времени игрок неуязвим после удара в секундах
GAMEOVERTIME = 5 # сколько времени в секундах остается на экране надпись "game over"
MAXHEALTH = 5 # сколько здоровья игрок начинает

NUMGRASS = 80 # количество травяных объектов в активной области
NUMSQUIRRELS = 30 # количество белок в активной области
SQUIRRELMINSPEED = 3 # самая медленная скорость белки
SQUIRRELMAXSPEED = 7 # максимальная скорость белки
DIRCHANGEFREQ = 2 # % вероятности смены направления на кадр
LEFT = 'left'
RIGHT = 'right'
...
def runGame():
    ...
    gameOverSurf = BASICFONT.render('Вы проиграли', True, WHITE)
    gameOverRect = gameOverSurf.get_rect()
    gameOverRect.center = (HALF_WINWIDTH, HALF_WINHEIGHT)

    winSurf = BASICFONT.render('ОГО! Выслишком большая белка', True, WHITE)
